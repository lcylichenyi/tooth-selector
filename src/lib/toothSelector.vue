<template>
  <div style="position: relative">
    <!-- <div class="btn-container">
      ...
      >
        <tr>
          <td v-html="aString" /><td v-html="bString" />
        </tr>
        <tr>
          <td v-html="cString" /><td v-html="dString" />
        </tr>
      </table>
      <p v-html="fString" />
    </div> -->
      ...
      <div class="body-left">
        <div class="body-left-1 clearfix">
          ...
          >
            ...
            <div
              class="fl interval"
              @click="choose($event,61)"
              :class="{'orange': teethInfo[60]['chosen'] === true}"
            >
              <input
                type="button"
                class="box interval-middle"
                :value="top_center[0].name"
                :id="top_center[0].id"
              >
            </div>
            <div
              class="fl interval"
              v-for="i in top_right_1"
              :key="i.id"
              @click="choose($event,i.id)"
              :class="{'orange': teethInfo[i.id-1]['chosen'] === true}"
            >
        ...
        <div class="body-left-2 clearfix">
          <div
            class="clearfix"
            id="body-left-2-line-1"
          >
            <div
              class="fl tooth"
              v-for="i in bottom_left_1"
              :key="i.id"
              @click="choose($event,i.id)"
              :class="{'orange': teethInfo[i.id - 1]['chosen'] === true}"
            >
          ...
          >
            ...
            <div
              class="fl interval"
              @click="choose($event,62)"
              :class="{'orange': teethInfo[61]['chosen'] === true}"
            >
              <input
                type="button"
                class="box interval-middle"
                :value="bottom_center[0].name"
                :id="bottom_center[0].id"
              >
            </div>
            <div
              class="fl interval"
              v-for="i in bottom_right_2"
              :key="i.id"
              @click="choose($event,i.id)"
              :class="{'orange': teethInfo[i.id - 1]['chosen'] === true}"
            >
