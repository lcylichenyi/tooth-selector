<template>
  <div id="app">
    ...
    <toothSelector :historyProp=test  v-model='teeth'  :maskArr="['a1', 'b3', 'c3']" :showContainer="true" ref="aa" />
    ...
    <div>其他的文章内容容容</div>
    <input type="button" value="test" @click="shit">
  </div>
</template>
...
export default {
  ...
  data () {
    return {
      test: { "d1": [ "La", "D" ], "d2": [], "a1": [ "P" ], "a4": [ "F" ], "b2": [ "" ], "c4": [ "" ], "d<6|7>": [] },
      isShow: true,
      teeth: {}
    }
  },
  methods: {
    shit() {
      console.log(this.$refs.aa.clear())
    },
    fucking () {
      this.teeth = {}
    }
